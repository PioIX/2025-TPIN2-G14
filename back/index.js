...
app.use(cors({
  origin: ["http://10.1.5.105:3000", "http://localhost:3000", "http://localhost:3002", "http://localhost:3003"],
  credentials: true
}));
...
const io = require('socket.io')(server, {
  cors: {
    origin: ["http://10.1.5.105:3000", "http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003"],

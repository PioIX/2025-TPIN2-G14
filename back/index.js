...
app.use(cors({
  origin: ["http://192.168.11.151:3000","http://10.1.5.133:3000", "http://localhost:3000", "http://localhost:3002", "http://localhost:3003"],
  credentials: true
}));
...
const io = require('socket.io')(server, {
  cors: {
    origin: ["http://192.168.11.151:3000","http://10.1.5.133:3000", "http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003"],
